...
if __name__ == '__main__' :
	...
	new_tree = postpruning( d_tree, test_data, attributes )
	display( new_tree , 1 )
	model_test( new_tree, test_data, attributes )
	model_test( new_tree, data, attributes ) 

	pre_tree = prepruning_DT( train_data, attributes, attributes_value, test_data )
	display( pre_tree, 1 )
